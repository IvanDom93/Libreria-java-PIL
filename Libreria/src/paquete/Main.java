        ...
        switch (respuesta){
            case 1:
                /*for(int i = 0;i < listadoLibros.length;i++){
                    System.out.println(listadoLibros[i].toString());
                }*/
            ...
            case 2:
                /*for(int i = 0;i < listadoComics.length;i++){
                    System.out.println(listadoComics[i].toString());
                }*/
                ...
                break;
            case 3:
                /*for(int i = 0;i < listadoRevista.length;i++){
                    System.out.println(listadoRevista[i].toString());
                }*/
